...
--
-- Host: localhost
-- Generation Time: Apr 06, 2018 at 10:23 PM
...
INSERT INTO `perros` (`id_perro`, `perro`, `id_raza`, `id_sexo`, `descripcion`, `edad`, `foto`, `precio`, `para_regalar`) VALUES
(1, 'pipo', 4, 2, 'buen perro', 3, 'ulr.com', 20, 1),
(2, 'pepo', 14, 2, 'bla perro bla', 3, 'ulr.com', 20, 1),
(3, 'papo', 24, 2, 'buen perro', 8, 'ulr.com', 20, 1);
...
CREATE TABLE `usuario` (
  ...
  `pass` varchar(99) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `email`, `pass`, `id_localidad`) VALUES
(1, 'lau', 'lau@lau', 'bnm', 7),
...
--
ALTER TABLE `perros`
  MODIFY `id_perro` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `transacciones`
  MODIFY `id_transacciones` int(99) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `usuario`
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int(88) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `usuarioAperro`
--
ALTER TABLE `usuarioAperro`
  MODIFY `id_usuarioAperro` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `perros`
  ADD CONSTRAINT `perros_ibfk_1` FOREIGN KEY (`id_sexo`) REFERENCES `sexos` (`id_sexo`),
  ADD CONSTRAINT `perros_ibfk_2` FOREIGN KEY (`id_raza`) REFERENCES `razas` (`id_raza`);

--
-- Constraints for table `transacciones`
--
ALTER TABLE `transacciones`
  ADD CONSTRAINT `transacciones_ibfk_1` FOREIGN KEY (`id_tipoTransa`) REFERENCES `tipoTransaccion` (`id_tipoTransa`),
  ADD CONSTRAINT `transacciones_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `transacciones_ibfk_3` FOREIGN KEY (`id_perro`) REFERENCES `perros` (`id_perro`);

--
-- Constraints for table `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id_localidad`) REFERENCES `localidades` (`id_localidad`);

--
-- Constraints for table `usuarioAperro`
--
ALTER TABLE `usuarioAperro`
  ADD CONSTRAINT `usuarioAperro_ibfk_1` FOREIGN KEY (`id_perro`) REFERENCES `perros` (`id_perro`),
  ADD CONSTRAINT `usuarioAperro_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);
COMMIT;
